...
const links = [["/dashboard", "Dashboard"], ["/meals", "Meals"], ["/goals", "Goals"], ["/analyze", "Analyze"], ["/imports", "Import PDF (Bonus)"], ["/chat", "Nutrition Assistant (Beta)"], ["/reports", "Reports"], ["/profile", "Profile"]] as const;
